    ...
    <div class="row justify-content-center">
        <div class="col-md-6 mt-4 mb-4">
            ...
            <div class="categoryadd_body">
                    <form action="{{route('admin.category.saveCategory')}}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" id="categoryDescription" name="categoryDescription" required></textarea>
