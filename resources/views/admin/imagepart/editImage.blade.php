            ...
            <div class="categoryadd_body">
                    <form action="" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="productimageTitle" name="productimageTitle" value="{{$showdata->productimageTitle}}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="productimageupload" name="productimageupload" required  value="{{asset('attendance_file/'.$showdata->productimageupload)}}">
                            <img id="blah" src="{{asset('attendance_file/'.$showdata->productimageupload)}}" alt="your image" />
