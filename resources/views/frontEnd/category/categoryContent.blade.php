                    ...
                    <div class="col-md-4 product-men no-pad-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                                ...
                                <img src="{{asset('frontEnd/images/')}}/ep2.png" alt="" class="pro-image-back">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('frontEnd.productDetails')}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                            </div>
                            ...
                            <div class="item-info-product ">
                                        <h4><a href="{{route('frontEnd.productDetails')}}">Watches</a></h4>
                                        <div class="info-product-price">
                                            <span class="item_price">$45.99</span>
                                            <del>$69.71</del>
                                        </div>
                                        <a href="{{route('frontEnd.productDetails')}}" class="item_add single-item hvr-outline-out button2">Add to cart</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 product-men no-pad-men">
