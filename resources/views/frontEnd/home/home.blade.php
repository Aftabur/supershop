            ...
            <div class="sap_tabs">
                <div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
                    <ul class="resp-tabs-list">
                        ...
                        <li class="resp-tab-item" aria-controls="tab_item-2" role="tab"><span>Upcomming</span></li>
                    </ul>
                            ...
                            <div class="col-md-3 product-men">
                                <div class="men-pro-item simpleCart_shelfItem">
                                    <div class="men-thumb-item">
                                        <img src="{{asset('attendance_file/'.$data->productImage)}}" alt="" class="pro-image-front">
                                        <img src="{{asset('attendance_file/'.$data->productImage)}}" alt="" class="pro-image-back">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="{{route('frontEnd.productDetails',$data->id)}}" class="link-product-add-cart">Quick View</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="item-info-product ">
                                        <h4><a href="{{route('frontEnd.productDetails',$data->id)}}">{{$data->productName}}</a></h4>
                                        ...
                                        <a href="{{route('frontEnd.productDetails',$data->id)}}" class="item_add single-item hvr-outline-out button2">Add to cart</a>
                                    </div>
                                </div>
                            </div>
                            @endforeach
